...
void PclPassThroughBoxFilter::filter(UpdatedHandles& /*input*/, const SensorPlugin* /*sensor*/) const
{
...
PLUGINLIB_EXPORT_CLASS(l3_terrain_modeling::PclPassThroughBoxFilter, l3_terrain_modeling::ProcessPlugin)
